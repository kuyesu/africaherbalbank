    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtitle', models.CharField(help_text='This is the Summary of the blog that appears on the blog listing page, Attractive messge', max_length=320, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='customcomments', to='blog.blogdetailpage')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('blogdetailpage_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='blog.blogdetailpage')),
                ('subtitle', models.CharField(blank=True, help_text='This is the Summary of the blog that appears on the blog listing page, Attractive messge', max_length=320, null=True)),
