...
class BlogListingPage(RoutablePageMixin, Page):
    ...
    content_panels = Page.content_panels + [
        ...
        # FieldPanel("introductory_message")
...
class ArticleBlogPage(BlogDetailPage):
    ...
    subtitle = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="This is the Summary of the blog that appears on the blog listing page, Attractive messge"
    )
...
"""class CustomComment(XtdComment):
    page = ParentalKey(ArticleBlogPage, on_delete=models.CASCADE, related_name='customcomments')

    def save(self, *args, **kwargs):
        if self.user:
            self.user_name = self.user.display_name
        self.page = ArticleBlogPage.objects.get(pk=self.object_pk)
        super(CustomComment, self).save(*args, **kwargs)
"""
